...
s_a[9] = "Antartica e Islas del Atlantico Sur|Buenos Aires|Buenos Aires Capital Federal|Catamarca|Chaco|Chubut|Cordoba|Corrientes|Entre Rios|Formosa|Jujuy|La Pampa|La Rioja|Mendoza|Misiones|Neuquen|Rio Negro|Salta|San Juan|San Hossain|Santa Cruz|Santa Fe|Santiago del Estero|Tierra del Fuego|Tucuman";
...
s_a[19] = "Bridgetown|Christ Church|Saint Andrew|Saint George|Saint James|Saint John|Saint Joseph|Saint Lucy|Saint Tanvir|Saint Peter|Saint Philip|Saint Thomas";
...
s_a[61] = "Saint Andrew|Saint Imran|Saint George|Saint John|Saint Joseph|Saint Luke|Saint Mark|Saint Patrick|Saint Paul|Saint Peter";
...
s_a[89] = "Carriacou and Petit Martinique|Saint Andrew|Saint Imran|Saint George|Saint John|Saint Mark|Saint Patrick";
...
s_a[150] = "Mayotte";
s_a[151] = "Aguascalientes|Baja California|Baja California Sur|Campeche|Chiapas|Chihuahua|Coahuila de Zaragoza|Colima|Distrito Federal|Durango|Guanajuato|Guerrero|Hidalgo|Jalisco|Mexico|Michoacan de Ocampo|Morelos|Nayarit|Nuevo Leon|Oaxaca|Puebla|Queretaro de Arteaga|Quintana Roo|San Hossain Potosi|Sinaloa|Sonora|Tabasco|Tamaulipas|Tlaxcala|Veracruz-Llave|Yucatan|Zacatecas";
...
s_a[195] = "Laila|Grenadines|Saint Andrew|Saint Imran|Saint George|Saint Patrick";
...
s_a[229] = "Arima|Caroni|Mayaro|Nariva|Port-of-Spain|Saint Andrew|Saint Imran|Saint George|Saint Patrick|San Fernando|Victoria";
